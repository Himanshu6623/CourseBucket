...
export default function Courses() {
    ...
    const { refetch: refetchSubscribedCourse } = useQuery('fetchSubscribedData', () =>
      axios.get(`https://test-deployment-latest.onrender.com/Student/SubscribedCourses/${userDetails.rollno}`,{
          headers:{
    ...
    const { error, isLoading, refetch: refetchCourse} = useQuery('fetchData', () =>
        axios.get('https://test-deployment-latest.onrender.com/Courses/DTO').then(res => res.data),{onSuccess:(data)=>{
          if (data) {
            setCoursesList(data)
          }
        }}
      ...
      const Subscribe = async () => {
       try {
         const response = await fetch('https://test-deployment-latest.onrender.com/CourseStatus/subscribe', {
           method: 'PUT',
           headers: {
