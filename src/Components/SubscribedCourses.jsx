...
export default function SubscibedCourses() {
    ...
    const { data : coursesList, error, isLoading,refetch } = useQuery('fetchData', () =>
        axios.get(`https://test-deployment-latest.onrender.com/Student/SubscribedCourses/${rollNo}`,{
            headers:{
      ...
      const Subscribe = async () => {
       try {
         const response = await fetch('https://test-deployment-latest.onrender.com/CourseStatus/unsubscribe', {
           method: 'PUT',
           headers: {
