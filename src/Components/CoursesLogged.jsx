...
export default function CoursesLogged() {
    ...
    const {error, isLoading, refetch} = useQuery('fetchData', () =>
        axios.get(`https://test-deployment-latest.onrender.com/Courses`,{
            headers: {
    ...
    const RemoveCourse = async () => {
       try {
         const response = await fetch(`https://test-deployment-latest.onrender.com/Courses/removeCourse/${courseId}`, {
           method: 'DELETE',
           headers: {
    ...
    const EditCourseData = async () => {
        try {
          const response = await fetch(`https://test-deployment-latest.onrender.com/Courses/UpdateCourse`, {
            method: 'PUT',
            headers: {
              'Content-type': 'application/json',
              Authorization: `Bearer ${token}`,
