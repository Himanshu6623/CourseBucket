...
export default function UserDetails() {
  ...
  const { isError, isLoading, refetch } = useQuery(
    ...
    () =>
      axios
        .get(`https://test-deployment-latest.onrender.com/Student`, {
          headers: {
  ...
  const DeleteStudentAccount = async () => {
    try {
      const response = await fetch(`https://test-deployment-latest.onrender.com/Student/RemoveStudent/${rollNo}`, {
        method: 'DELETE',
        headers: {
  ...
  const changeStudentPassword = async () => {
    try {
      const response = await fetch(`https://test-deployment-latest.onrender.com/Admin/StudentPasswordChange`, {
        method: 'PUT',
        headers: {
          'Content-type': 'application/json',
          Authorization: `Bearer ${token}`,
