...
export default function AdminLogin() {
  ...
  const adminLogin = async () => {
    const response = await fetch(`https://test-deployment-latest.onrender.com/Admin/login`, {
      method: "POST",
  ...
  const fetchAdminDetails = async () => {
    const { data } = await axios.get(`https://test-deployment-latest.onrender.com/Admin/AdminId/${id}`, {
